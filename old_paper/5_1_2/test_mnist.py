...
if args.epoch == 200:
    if 'Conv' in args.model:
        checkpoint_path = './ckpts/adv_pool/mnist_paddingsize/simple_%s_%d_%d_%d.pth'%(args.model, args.kernel_size, args.padding_size, args.n_hidden)
else:
    checkpoint_path = './ckpts/adv_pool/mnist_paddingsize/simple_%s_%d_%d.pth'%(args.model, args.n_hidden, args.epoch)
