...
if testing_mode == "T":
    ...
    with open('extension_pooling_layers/fashion_mnist_accuracy_data.pkl', 'wb') as file:
        pickle.dump(accuracy_data, file)

    # Save the model names
    with open('extension_pooling_layers/fashion_mnist_model_names.pkl', 'wb') as file:
