    ...
    for norm, epsilons in attack_params:
        ...
        for epsilon in epsilons:
            ...
            if norm == 2:
                ...
                attack = ProjectedGradientDescentTensorFlowV2(estimator=classifier, eps=epsilon, eps_step=epsilon/5, max_iter=5, batch_size=100, norm=norm)
