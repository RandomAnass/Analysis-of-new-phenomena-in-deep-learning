...
acc_array_file = '2_fashion_mnist_acc_array.pkl'
loss_array_file = '2_fashion_mnist_loss_array.pkl'
model_consistency_file = '2_fashion_mnist_model_consistency_dict.pkl'
accuracy_data_file = '2_fashion_mnist_accuracy_data.pkl'
model_names_file = '2_fashion_mnist_model_names.pkl'
models_file = '2_fashion_mnist_models.pkl'
...
attack_params = [[np.inf, [0.05, 0.125, 0.2]],[2, [0.5, 1,  1.5]]]
#attack_params = [[np.inf, [0.05, 0.1,  0.15, 0.2, 0.25, 0.3]],[2, [0.5, 1, 1.5,  2.5, 3]]]

save_dir = "extension_pooling_layers/extension_pooling_layers"
...
n_layers_list = [1,3,5]#[1, 2, 3, 4]
add_dense_list = [False]
max_pooling_list = [True]
kernel_size_list = [2,3,10,14,20]#[2, 3, 6, 10, 14, 20] # 4*6=24
...
update_file(accuracy_data_file, accuracy_data)
update_file(model_names_file, model_names)
update_file(models_file, models)
    ...
    for add_dense in add_dense_list:
        for max_pooling in max_pooling_list:
            for kernel_size in kernel_size_list:
                ...
                update_file(accuracy_data_file, accuracy_data)
                update_file(models_file, models)
                model_name_h5 = f'{list(model_names.keys())[i]}.h5'
                classifier.model.save(model_name_h5)
